...
function Figurado(props) {
  ...
  function darPalpite(palpite) {
    ...
    if (palpites.erros > 0) {
      store.dispatch(GetPalpites(palpite, figurado));
    }
  }
  ...
  function chutarJogador(jogador, id) {
    store.dispatch(ChutarJogador(jogador, id));
  }

  if (opções === null || figurado === null) {
            ...
            <Col md={4}>
              ...
              <div className="figurado__palpites">
                ...
                { palpites.opções.map( (palpite, i) => 
                  <div className='figurado__palpites__palpite' style={{ backgroundColor: palpite.certo ? '#1ede75' : '#ff007b' }} key={i}>
                    <Container fluid>
                      <Row>
                        <Col md={3}>
  ...
  
                  {
                    ...
                    <div>
                      <form>
                        ...
                        <input placeholder='digite para selecionar o jogador' onChange={(e) => searchJogador(e.target.value)} type="text" className="figurado__palpites__chute__input" />
                      </form>
                    ...
                    :<div className="figurado__palpites__chute__jogador">
                      ...
                      <button onClick={() => chutarJogador(palpites.jogador.id, figurado.id)} className="figurado__palpites__chute__jogador__button">chutar pro gol</button>
